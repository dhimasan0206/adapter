...
// checks if the ProductsRequestProductsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductsRequestProductsInner{}
...
func NewProductsRequestProductsInner() *ProductsRequestProductsInner {
	this := ProductsRequestProductsInner{}
	return &this
}
...
type NullableProductsRequestProductsInner struct {
	value *ProductsRequestProductsInner
	isSet bool
}
...
func NewNullableProductsRequestProductsInner(val *ProductsRequestProductsInner) *NullableProductsRequestProductsInner {
	return &NullableProductsRequestProductsInner{value: val, isSet: true}
}
